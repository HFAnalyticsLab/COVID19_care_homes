...
data interim.apcs_3_1420_final_2_adm changed unchanged;
	length rgn19nm_2 rgn19nm rgn19nm_adm rgn19nm_disch rgn19nm_sus $ 24;
	set interim.apcs_3_1420_final_2;
	if rgn19nm_adm ~= '' then do;
		if rgn19nm ~= rgn19nm_adm then do;
			rgn19nm_2 = rgn19nm_adm;
			output changed;
		end;
		else do;
			rgn19nm_2 = rgn19nm;
	...
	else rgn19nm_2 = rgn19nm;
	output interim.apcs_3_1420_final_2_adm;
run;
...
proc sql;
	create table interim.admbytime_&myext as
	select rgn19nm_2 as rgn19nm, ch_nursing_adm, spellstartdate, chadm, count(spellstartdate) as freq, admday, admmnth, admyr
	from &mysource
	group by rgn19nm_2, ch_nursing_adm, spellstartdate, chadm, admday, admmnth, admyr
	order by admyr, admmnth, admday, rgn19nm_2, ch_nursing_adm;
quit;
